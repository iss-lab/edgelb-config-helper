...
// V2Pool The pool contains information on resources that the pool needs. Changes make to this section will relaunch the tasks.
//
// swagger:model V2Pool
type V2Pool struct {
	...
	// A cloud provider load-balancer configuration.
	CloudProvider *V2CloudProvider `json:"cloudProvider,omitempty"`
	...
	// DC/OS secrets.
	Secrets []*V2PoolSecretsItems0 `json:"secrets"`
	...
	VirtualNetworks []*V2PoolVirtualNetworksItems0 `json:"virtualNetworks"`
}

func (m *V2Pool) UnmarshalJSON(b []byte) error {
	type V2PoolAlias V2Pool
	var t V2PoolAlias
	if err := json.Unmarshal([]byte("{\"apiVersion\":\"V2\",\"constraints\":\"hostname:UNIQUE\",\"count\":1,\"cpus\":0.9,\"cpusAdminOverhead\":0.1,\"disk\":256,\"haproxy\":{},\"mem\":992,\"memAdminOverhead\":32,\"packageName\":\"edgelb-pool\",\"packageVersion\":\"v1.5.1\",\"poolHealthcheckGracePeriod\":180,\"poolHealthcheckInterval\":12,\"poolHealthcheckMaxFail\":5,\"poolHealthcheckTimeout\":60,\"ports\":[],\"role\":\"slave_public\",\"secrets\":[],\"type\":\"static\",\"virtualNetworks\":[]}"), &t); err != nil {
		return err
	}
...
// Validate validates this v2 pool
func (m *V2Pool) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V2Pool) validateAPIVersion(formats strfmt.Registry) error {
...
func (m *V2Pool) validateCloudProvider(formats strfmt.Registry) error {
...
func (m *V2Pool) validateHaproxy(formats strfmt.Registry) error {
...
func (m *V2Pool) validatePoolHealthcheckGracePeriod(formats strfmt.Registry) error {
...
func (m *V2Pool) validatePoolHealthcheckInterval(formats strfmt.Registry) error {
...
func (m *V2Pool) validatePoolHealthcheckMaxFail(formats strfmt.Registry) error {
...
func (m *V2Pool) validatePoolHealthcheckTimeout(formats strfmt.Registry) error {
...
func (m *V2Pool) validateSecrets(formats strfmt.Registry) error {
...
func (m *V2Pool) validateType(formats strfmt.Registry) error {
...
func (m *V2Pool) validateVirtualNetworks(formats strfmt.Registry) error {
...
func (m *V2Pool) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V2Pool) UnmarshalBinary(b []byte) error {
	var res V2Pool
...
// V2PoolSecretsItems0 v2 pool secrets items0
//
// swagger:model V2PoolSecretsItems0
type V2PoolSecretsItems0 struct {
...
// Validate validates this v2 pool secrets items0
func (m *V2PoolSecretsItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *V2PoolSecretsItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V2PoolSecretsItems0) UnmarshalBinary(b []byte) error {
	var res V2PoolSecretsItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// V2PoolVirtualNetworksItems0 v2 pool virtual networks items0
//
// swagger:model V2PoolVirtualNetworksItems0
type V2PoolVirtualNetworksItems0 struct {
...
// Validate validates this v2 pool virtual networks items0
func (m *V2PoolVirtualNetworksItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *V2PoolVirtualNetworksItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V2PoolVirtualNetworksItems0) UnmarshalBinary(b []byte) error {
	var res V2PoolVirtualNetworksItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
